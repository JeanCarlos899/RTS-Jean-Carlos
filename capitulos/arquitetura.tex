...
Cada requisição HTTP passa por um \textit{pipeline} estruturado de \textit{middleware}, \textit{guards}, \textit{interceptors} e \textit{filters}, garantindo segurança e consistência. A \autoref{fig:request-pipeline} ilustra este pipeline.
