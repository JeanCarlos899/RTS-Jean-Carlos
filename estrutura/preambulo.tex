...
\usepackage{ragged2e} % Para um alinhamento à esquerda sem hifenização estranha
...
% Correção para o comando \itseries não definido
\providecommand{\itseries}{\itshape}
