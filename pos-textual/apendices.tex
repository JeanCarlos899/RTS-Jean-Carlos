...
\begin{apendicesenv}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.6, every node/.style={transform shape}]
      ...
      % --- AGRUPAMENTO SUPERIOR: Organizacional e Recursos ---
      % Company é a raiz central. User, Driver e Vehicle são seus recursos diretos.
      \umlclass[x=8, y=16]{Company}{
        id: uuid\\
        legalName: string\\
        tradeName: string\\
        slug: string\\
      ...
      % --- AGRUPAMENTO ESQUERDA/CENTRO: Configuração de Rotas ---
      % Itens que definem a estrutura das viagens: Endereços, Paradas e Rotas.
      \umlclass[x=-6, y=8]{Address}{
        id: uuid\\
        cep: string\\
        street: string\\
        number: string\\
      ...
      \umlclass[x=11, y=0]{RouteSchedule}{
        id: uuid\\
        routeId: uuid\\
        dayOfWeek: number\\
        isActive: boolean
      ...
      % --- AGRUPAMENTO INFERIOR: Operacional ---
      % Entidades que representam a execução: Viagens, Bilhetes e alocação de veículos/motoristas.
      \umlclass[x=8, y=-8]{Trip}{
        id: uuid\\
        routeId: uuid\\
        departureTime: Date\\
      ...
      % Composição: Company é a raiz de tudo
      \umlcompo[mult1=1, mult2=*]{Company}{User}
      \umlcompo[mult1=1, mult2=*]{Company}{Vehicle}
      \umlcompo[mult1=1, mult2=*]{Company}{Driver}
      \umlcompo[mult1=1, mult2=*]{Company}{Stop}
      \umlcompo[mult1=1, mult2=*]{Company}{Route}
      \umlcompo[mult1=1, mult2=*]{Company}{Trip}

      % Composição no agregado de Configuração
      \umlcompo[mult1=1, mult2=1]{Stop}{Address}
      \umlcompo[mult1=1, mult2=*]{Route}{RouteSchedule}
      \umlcompo[mult1=1, mult2=*]{Route}{RouteStop}
      \umluniassoc[mult1=*, mult2=1]{RouteStop}{Stop} % Associação (referência)

      % Composição no agregado Operacional
      \umlcompo[mult1=1, mult2=*]{Trip}{TripVehicle}
      \umlcompo[mult1=1, mult2=*]{Trip}{Ticket}

      % Associações (referências) entre agregados
      \umluniassoc[mult1=*, mult2=1]{Trip}{Route}
      \umluniassoc[mult1=*, mult2=1]{TripVehicle}{Driver}
      \umluniassoc[mult1=*, mult2=0..1]{TripVehicle}{Driver}
